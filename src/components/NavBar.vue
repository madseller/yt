<template>
	<nav class="relative w-full flex flex-wrap items-center justify-center px-5 py-5 sm:px-6">
	...
	<div class="alert">
		Сайт находится в на стадии тестирования, возможны некоторые сбои в работе, в скором времени все будет исправлено.
	</div>
...
export default {
	...
	computed: {
		...
		shouldShowHistory(_this) {
			return _this.getPreferenceBoolean("watchHistory", true);
		},
...
<style>
nav {
	border-bottom: 1px solid #f4194f;
}
nav li a {
	margin-left: 20px;
}
