...
export default {
    ...
    activated() {
        document.title = this.$t("titles.preferences") + " - Fruyt";
    },
    async mounted() {
        ...
        if (this.testLocalStorage) {
            this.selectedInstance = this.getPreferenceString("instance", import.meta.env.VITE_FRUYT_API);
            ...
            this.countrySelected = this.getPreferenceString("region", "RU");
    ...
    methods: {
        ...
        async fetchInstances() {
            ...
            this.fetchJson(import.meta.env.VITE_FRUYT_INSTANCES).then(resp => {
