    ...
    <LoadingIndicatorPage :show-content="channel != null && !channel.error">
        ...
        <div class="flex flex-col items-center justify-between md:flex-row">
            <div class="flex place-items-center">
                <img height="48" width="48" class="m-1 rounded-full" :src="channel.avatarUrl" alt=""/>
...
export default {
    ...
    activated() {
        if (this.channel && !this.channel.error) document.title = this.channel.name + " - Fruyt";
            ...
            this.fetchChannel()
                ...
                .then(() => {
                    if (!this.channel.error) {
                        document.title = this.channel.name + " - Fruyt";
