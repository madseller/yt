...
const mixin = {
    methods: {
        ...
        apiUrl() {
            return this.getPreferenceString("instance", import.meta.env.VITE_FRUYT_API);
        },
        authApiUrl() {
        ...
        async createPlaylist(name) {
            if (!this.authenticated) {
                ...
                this.createOrUpdateLocalPlaylist({
                    ...
                    name: name,
                    description: "",
                    thumbnail: import.meta.env.VITE_FRUYT_PROXY + "/?host=i.ytimg.com",
                    videoIds: "[]", // empty list
                });
        ...
        async removeVideoFromPlaylist(playlistId, index) {
            if (!this.authenticated) {
                ...
                if (videoIds.length == 0) playlist.thumbnail = import.meta.env.VITE_FRUYT_PROXY + "/?host=i.ytimg.com";
                this.createOrUpdateLocalPlaylist(playlist);
                return { message: "ok" };
            }
