...
export default {
    ...
    mounted() {
        ...
        if ("indexedDB" in window) {
            const request = indexedDB.open("fruyt-db", 6);
...
<style>
@import url('https://fonts.googleapis.com/css2?family=IBM+Plex+Sans&family=Zain:wght@200;300;400;700;800;900&display=swap');
body * {
